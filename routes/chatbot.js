...
import { authenticateToken, requireAnyRole, requireAdmin } from "../middleware/auth.js";
...
const chatbotData = {
  hostel_rules: {
    ...
    answer:
      "Hostel rules include: 1) Curfew time is 10 PM, 2) No smoking or alcohol, 3) Keep rooms clean, 4) Respect others, 5) Follow meal timings, 6) No unauthorized visitors after 8 PM.",
  },
  meal_timings: {
    question: "What are the meal timings?",
    answer:
      "Breakfast: 7–9 AM, Lunch: 12–2 PM, Dinner: 7–9 PM. Please follow these timings strictly.",
  },
  visitor_policy: {
    question: "What is the visitor policy?",
    answer:
      "Visitors are allowed from 9 AM–8 PM. All must register at reception with valid ID. Students are responsible for visitor behavior.",
  },
  laundry_service: {
    question: "How does laundry service work?",
    answer:
      "Laundry is available Monday–Friday. Submit clothes before 10 AM; pickup next day. Charges apply per rate card.",
  },
  maintenance_requests: {
    question: "How to request maintenance?",
    answer:
      "Submit maintenance requests via the portal or contact the maintenance office. For urgent issues, call the emergency number.",
  },
  fees_payment: {
    question: "How to pay hostel fees?",
    answer:
      "Fees can be paid online through the portal or at the admin office. Keep the receipt for your records.",
  },
  emergency_contacts: {
    question: "What are the emergency contacts?",
    answer:
      "Security: +91-XXXX-XXXX, Admin: +91-XXXX-XXXX, Medical: +91-XXXX-XXXX. For fire emergencies, call 101.",
  },
  room_allocation: {
    question: "How is room allocation done?",
    answer:
      "Rooms are assigned based on availability and preferences. Contact admin for room change requests. No unauthorized swaps.",
  },
  internet_wifi: {
    question: "What about internet and Wi-Fi?",
    answer:
      "Free Wi-Fi available in all areas. Internet usage is monitored. Report connectivity issues to IT support.",
  },
  library_facilities: {
    question: "What library facilities are available?",
    answer:
      "Library open 8 AM–10 PM. Books can be issued for 15 days. Late return charges apply. Maintain silence.",
  },
};
...
router.post(
  ...
  async (req, res) => {
    try {
      ...
      return res
        .status(500)
        .json({ success: false, message: "Failed to process chatbot request" });
    }
  }
);
